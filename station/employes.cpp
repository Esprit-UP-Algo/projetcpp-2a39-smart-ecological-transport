  ...
  {       ui->setupUi(this);
     ...
     ui->lineEdit_16->setValidator(new QIntValidator (0,99999999,this));
           QPushButton *returnButton = new QPushButton("Retour", this);
                      ...
                      connect(returnButton, &QPushButton::clicked, this, &employes::returnToHomepage);
...
void employes::on_lineEdit_6_textChanged(const QString &arg1)
{
     ui->tableView->setModel(Etmp.recherche(arg1));
}

void employes::on_pushButton_3_clicked() // ajouter congé
{
...
void employes::on_supp_clicked()//supprimer congé
{
    int id_c=ui->lineEdit_5->text().toInt();
...
void employes::on_pushButton_2_clicked() //refuser congé
{
    int id_c=ui->lineEdit_5->text().toInt();
...
void employes::on_confirmer_clicked()//confirmer congé
{
    int id_c=ui->lineEdit_5->text().toInt();
...
void employes::on_pushButton_4_clicked()//retour
{
    ui->lineEdit_5->clear();
    ui->dateEdit_2->clear();
    ui->dateEdit_4->clear();
...
void employes::handleEnrollmentResult(bool success) {
    if (success) {
...
void employes::handleVerificationResult(bool success) {
    if (success) {
...
void employes::enrollFingerprintButtonClicked() {
...
void employes::verifyFingerprintButtonClicked() {
...
void employes::returnToHomepage() {
