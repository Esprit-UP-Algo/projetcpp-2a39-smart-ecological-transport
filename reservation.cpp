...
{
     nom=""; prenom="";num=0 ;datedebut=""; cin=0 ;email="",datefin="",durer="";

}
reservation::reservation(QString nom ,QString prenom,int num,QString datedebut , int cin,QString email,QString datefin,QString durer)
{
...
{return email;}
QString reservation ::getdatefin()
{return datefin;}
QString reservation ::getdurer()
{return durer;}
...
{this->email=email;}
void reservation ::setdatefin(QString datefin)
{this->datefin=datefin;}
void reservation ::setdurer(QString durer)
{this->durer=durer;}
...
bool reservation::ajouter()
{
    ...
    QString cin_string=QString::number(cin);
          ...
          query.prepare("insert into RESERVATION (NOM ,PRENOM,NUM,DATEDEBUT,CIN,EMAIL,DATEFIN,DURER) "
                        "VALUES ( :nom,:prenom,:num,:datedebut,:cin,:email,:datefin,:durer)");
          ...
          query.bindValue(6,datefin);
          query.bindValue(7,durer);
...
QSqlQueryModel * reservation::affichier()
{
    ...
    model->setHeaderData(5,Qt::Horizontal,QObject::tr("EMAIL"));
     model->setHeaderData(6,Qt::Horizontal,QObject::tr("DATEFIN"));
      model->setHeaderData(7,Qt::Horizontal,QObject::tr("DURER"));
...
bool reservation::modifier ( QString nom, QString prenom,int num, QString datedebut ,int cin, QString email,QString datefin,QString durer) {
    QSqlQuery query;
    qDebug() << query.lastQuery();

    query.prepare("UPDATE reservation SET  NOM=:nom, PRENOM=:prenom,NUM=:num, DATEDEBUT=:datedebut, CIN=:cin, EMAIL=:email,DATEFIN=:datefin,DURER=:durer WHERE NUM=:num");
...
void reservation::exportpdf(QString s) {
    ...
    painter.drawText(7500, 3300, "DATEFIN");
    painter.drawText(8000, 3300, "DURER");
