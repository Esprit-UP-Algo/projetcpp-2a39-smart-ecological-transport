    ...
    : QWidget(parent), ui(new Ui::espacepro)
{
    ...
    QPixmap img8("C:/Users/MICRO-PC/Downloads/bb.jpg");
...
QString buttonStyle = "QPushButton {""border-radius: 25px;" "color: white;""background-color: white;"
  "background-image: url(C:/Users/MICRO-PC/OneDrive/Bureau/emm.png);""background-repeat: no-repeat;"
    ...
    "border-radius: 25px;"
        ...
        QPushButton *returnButton = new QPushButton("Quitter", this);
...
void espacepro::on_pushButton_2_clicked()
{
    clients *otherWidget = new clients;
    otherWidget->show();
...
void espacepro::on_pushButton_3_clicked()
{
    Vehicule *otherWidget = new  Vehicule;
    otherWidget->show();
